...
<h1>Registro de un nuevo Permiso<b style="color:#6A5ACD;"></b></h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" required value="{{old('name')}}" style="border-color: #6A5ACD;" autofocus>
                                @error('name')
                        ...
                        <div class="col-md-12 d-flex justify-content-center">
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary" style="background-color: #5A9BD4; color:white;">
                                    <i class="fas fa-save"></i> Registrar Permiso
                                </button>
