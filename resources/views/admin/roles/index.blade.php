...
<h1>Bienvenido ROLES<b style="color:#1E90FF;"></b></h1>
                            ...
                            <td style="text-align:center;">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <form action="{{ url('/admin/roles', $role->id) }}" method="post" id="miFormulario{{$role->id}}">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" title="Eliminar" id="deleteBtn{{$role->id}}" style="border-radius:0px 5px 5px 0px">
                                    ...
                                    <script>
                                        ...
                                        document.addEventListener('DOMContentLoaded', function() {
                                            ...
                                            const deleteButton = document.getElementById('deleteBtn{{$role->id}}');
                                            ...
                                            deleteButton.addEventListener('click', function(event) {
                                                ...
                                                Swal.fire({
                                                    ...
                                                    if (result.isConfirmed) {
                                                        ...
                                                        var form = document.getElementById('miFormulario{{$role->id}}');
