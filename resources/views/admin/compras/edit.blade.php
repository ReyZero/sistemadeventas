...
<h1>Modificar datos de la Compra<b style="color:#1E90FF;"></b></h1>
...
-->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="fecha" required value="{{ $compra->fecha}}">
                                        @error('fecha')
                                        <small style="color:red;">{{$message}}</small>
                                        @enderror
                                    </div>
            ...
            <div class="row">
                <div class="col-md-12 d-flex justify-content-center">
                    <div class="form-group">
                        <button type="submit" class="btn btn-info" style="background-color: info; color:white;"><i class="fas fa-shopping-cart"></i> Modificar Compra</button>
