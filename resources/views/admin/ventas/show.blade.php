...
<h1>Detalla de la Venta<b style="color:#1E90FF;"></b></h1>
                    ...
                    <hr style="background-color: #00BC8C; height: 1px; border: none;">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="nombre_cliente_select" disabled required value="{{$ventas->cliente->nombre_cliente ?? 'S/N'}}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="nit_cliente_select" disabled required value="{{$ventas->cliente->nit_codigo ??'0'}}">                                    
                                </div>                                
                            </div>
                            <hr style="background-color: #00BC8C; height: 1px; border: none;">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="fecha" disabled value="{{$ventas->fecha}}">
                                        @error('fecha')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" style="text-align: center;">
                                    <label for="precio_total">Precio Total Venta</label><b style="color: crimson;"> </b>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">$ </span>
                                        </div>
                                        <input type="text" style="text-align: center; background-color: #3c8dbc; border: 1px solid #8da5b8;" value="{{number_format($total_venta,0,',','.')}}" class="form-control" name="precio_total" disabled required value="">
                                        @error('precio_total')
                                        <small style="color:red;">{{$message}}</small>
                                        @enderror
                                    </div>
