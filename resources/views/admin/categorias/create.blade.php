...
<h1>Registro de una nueva Categoria<b style="color:#1E90FF;"></b></h1>
                ...
                <form action="{{url('/admin/categorias/create')}}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-center">
                            <div class="form-group">
                                <button type="submit" class="btn btn-success" style="background-color: success; color:white;"><i class="fas fa-save"></i> Registrar Categoría</button>
