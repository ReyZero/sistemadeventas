...
<head>
    ...
    <title>Reporte de Ventas / Sistema de Ventas</title>
    <style>
...
<body>
    ...
    <br>
    <div class="content">
        <h2>Reporte de Ventas del Sistema</h2>
        <hr>
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <th width="110px">Precio Total</th>
                    <th width="110px">Cliente</th>
                    <th width="110px">RUT</th>
