                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                $ {{ number_format($tmp_venta->producto->precio_venta, 0, ',', '.') }}
                                            </td>
                                            <td style="text-align: center;">
                                                $ {{ number_format($costo = $tmp_venta->cantidad * $tmp_venta->producto->precio_venta, 0, ',', '.') }}
                                            </td>
                                            <td style="text-align: center;">
                                                <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{$tmp_venta->id}}" title="Eliminar">
